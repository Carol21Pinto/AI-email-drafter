...
function JobAnalyzer({ onApplicationSent }) {
    ...
    const [resumeUrl, setResumeUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    // --- NEW: RESUME UPLOAD FUNCTION ---
    async function handleFileUpload(event) {
        ...
        setIsUploading(true);
        try {
            // 1. Upload to Supabase bucket 'resumes'. We use upsert:true to overwrite the old one.
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('resumes').upload('my_master_resume.pdf', file, {
                cacheControl: '3600',
                upsert: true
            });
            if (error) throw error;
            // 2. Get the public URL
            const { data: { publicUrl } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('resumes').getPublicUrl('my_master_resume.pdf');
            setResumeUrl(publicUrl);
            alert("Resume uploaded successfully!");
        } catch (error) {
            console.error("Upload error:", error);
            alert("Failed to upload resume. Check your Supabase bucket settings.");
        } finally{
    ...
    async function handleAnalyze() {
        ...
        try {
            ...
            setAnalysis({
                ...
                role: data.role,
                recruiterEmail: manualEmail || "pending@email.com",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: resumeUrl ? "my_master_resume.pdf" : "Upload Resume (PDF)"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/JobAnalyzer.tsx",
                                                lineNumber: 215,
                                                columnNumber: 15
...
//# sourceMappingURL=src_10tgmgc._.js.map