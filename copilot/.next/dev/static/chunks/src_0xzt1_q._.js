...
function JobAnalyzer({ onApplicationSent }) {
    ...
    const [resumeUrl, setResumeUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    async function handleFileUpload(event) {
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('resumes').upload('my_master_resume.pdf', file, {
                cacheControl: '3600',
                upsert: true
            });
            if (error) throw error;
            // 2. Get the public URL
            const { data: { publicUrl } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('resumes').getPublicUrl('my_master_resume.pdf');
...
_s(JobAnalyzer, "ifXcJo3Lv8f1Vf7kWR+9MwTFSs4=");
_c1 = JobAnalyzer;
var _c, _c1;
...
//# sourceMappingURL=src_0xzt1_q._.js.map